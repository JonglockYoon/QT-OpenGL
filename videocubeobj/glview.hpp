...
public:
    ...
    void DoCubeDisplay(const SBBox& pBBox);

    GLuint id_ogl_texture[6];// OpenGL texture ID.

public:
#define videoFile "ball_tracking_example.mp4"
    cv::Mat cameraFeed;
    ...
    const int FRAME_WIDTH = 640;//1200;
    const int FRAME_HEIGHT = 480;//640;
